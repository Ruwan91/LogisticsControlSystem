 ...
 * @author ishan
 */
@WebServlet(name = "delete_release_cargo", urlPatterns = {"/delete_release_cargo"})
public class delete_release_cargo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                /* TODO output your page here. You may use following sample code. */
                int w_id = Integer.parseInt(request.getParameter("wout_id"));
